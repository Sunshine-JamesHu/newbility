...
let OssCoreModule = class OssCoreModule extends AppModule_1.AppModule {
};
OssCoreModule = __decorate([
    (0, AppModule_1.ModulePath)(__dirname),
    (0, Dependency_1.Injectable)(),
    (0, DependsOn_1.DependsOn)(CoreModule_1.CoreModule)
], OssCoreModule);
exports.OssCoreModule = OssCoreModule;
//# sourceMappingURL=OssCoreModule.js.map