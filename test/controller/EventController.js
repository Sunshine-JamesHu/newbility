...
const EventBus_1 = require("../../src/core/src/event/EventBus");
let EventController = class EventController extends Controller_1.Controller {
...
], EventController.prototype, "Trigger", null);
EventController = __decorate([
    (0, Dependency_1.Injectable)(),
    (0, Dependency_1.Transient)(),
    (0, Router_1.Router)({ desc: '事件测试' }),
    __param(0, (0, Dependency_1.Inject)(EventBus_1.EVENT_BUS_INJECT_TOKEN)),
